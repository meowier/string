...
var urlEncode = () => {
    ...
    returnFunc(encodeURIComponent(e));
}

var urlDecode = () => {
    let e  = document.getElementById('input').value;
    returnFunc(decodeURIComponent(e));
}
...
var utf8Encode = () => {
	...
	let hex;
	while (++index < length) {
		hex = e.charCodeAt(index).toString(16).toUpperCase();
		out += "\\x" + ("00" + hex).slice(-2)
	}
    returnFunc(out);
}
...
var utf8Decode = () => {
	...
	for(let i = 0; i < e.length; i += 2){
		out += String.fromCharCode(parseInt(e.substr(i, 2), 16));
	}
...
var  base64Encode = () => {
	let e  = document.getElementById('input').value;
	returnFunc(Base64.encode(e));
}

var  base64Decode = () => {
	let e  = document.getElementById('input').value;
	returnFunc(Base64.decode(e));
}

var htmlEncode = () => {
	let e  = document.getElementById('input').value;
	returnFunc(Encoder.htmlEncode(e));
}
...
var hexToStr = () => {
	let e = document.getElementById('input').value.indexOf(' ') === -1 ? this : document.getElementById('input').value.replace(/ /g, '');
	let out = '';
	for(let i = 0; i < e.length; i += 2){
		out += String.fromCharCode(parseInt(e.substr(i, 2), 16));
	}
...
var strLen = () => {
	returnFunc(document.getElementById('input').value.length);
}
var revStr = () => {
	returnFunc(document.getElementById('input').value.split('').reverse().join(''));
}

var upperCase = () => {
	returnFunc(document.getElementById('input').value.toUpperCase());
}

var lowerCase = () => {
	returnFunc(document.getElementById('input').value.toLowerCase());
}

var upsideDown = () => {
    let e = flipString(document.getElementById("input").value);
    returnFunc(e);
}

var buildStr = () => {
	let e = document.getElementById('input').value.split('\n');
	let out = '';
...
var reAcce = () => {
	...
	for(let i in diacriticsMap){
			out = out.replace(diacriticsMap[i].letters, diacriticsMap[i].base);	
	}
	returnFunc(out);
}
var remRep = () => {
	...
	returnFunc(e.split(find).join(rep));
}
var splitStr = () => {
	let e = document.getElementById('input').value;
